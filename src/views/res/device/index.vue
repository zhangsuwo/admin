  ...
  <el-container>
    ...
    <el-main class="nopadding">
      <scTable ref="table" :apiObj="apiObj" :params="query" row-key="id" stripe highlightCurrentRow>
        ...
        <el-table-column fixed label="设备ID" prop="deviceID"></el-table-column>
        ...
        <el-table-column fixed label="版本" prop="version"></el-table-column>
        <el-table-column fixed label="IP" prop="ip"></el-table-column>
        <el-table-column fixed label="绑定Token" prop="token"></el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      apiObj: this.$API.res.device.list,
